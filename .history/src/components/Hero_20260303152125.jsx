...
import LeftLeaf  from '/hero-left-leaf.png'
import RightLeaf  from '/hero-right-leaf.png'
import CocktailAnimation  from '/output.mp4'
...
const Hero = () => {
    ...
    useGSAP(()=> {
        ...
        const endtValue = isMobile ? '120% top' : 'bottom top';
